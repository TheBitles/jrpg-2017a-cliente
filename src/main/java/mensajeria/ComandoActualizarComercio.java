...
public class ComandoActualizarComercio extends ComandosEscucha {
	...
	public void ejecutar() {
		...
		if(juego.getCliente().getPaqueteComercio().getListo() =jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjn= paqueteComerciar.getListo()) {
				//actualizar la lista
