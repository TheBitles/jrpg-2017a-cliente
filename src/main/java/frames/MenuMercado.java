...
public class MenuMercado extends JFrame {
	...
	//ArrayList<JPanel> viewsPanelOferta = new ArrayList<JPanel>(Personaje.MAX_ITEMS);
	//ArrayList<JPanel> viewsPanelIntercambioOferta = new ArrayList<JPanel>(Personaje.MAX_ITEMS/2);
	//ArrayList<JPanel> viewsPanelIntercambioDemanda = new ArrayList<JPanel>(Personaje.MAX_ITEMS/2);
	//ArrayList<JPanel> viewsPanelDemanda = new ArrayList<JPanel>(Personaje.MAX_ITEMS);
	...
	public static void main(String[] args) {
		MenuMercado.getInstance().dibujar(new PaquetePersonaje(), new Point(0,0));
	}
	...
	private void dibujarPanelOferta() {
		...
		// prueba
		for(int i = 0; i<6 ; i++) {
			items.add(new Item(1, "Hello Moto", 1, 1, 1, 0, 0));
		}
		// borrar
